...
export const STYLES = `
  ...
  *{box-sizing:border-box;}
  ...
  .hword{font-size:18px;font-weight:700;letter-spacing:1px;color:#fff;flex:1;}
  ...
  .tab{padding:10px 16px;cursor:pointer;font-size:11px;font-weight:600;
  ...
  .cfg-title{font-size:13px;font-weight:600;color:var(--tx);letter-spacing:.3px;}
  .cfg-saving{font-size:11px;color:var(--sub);}
  ...
  .albl{font-size:12px;color:var(--tx);}
  .asub{font-size:11px;color:var(--sub);}
  .doms-hd{display:flex;align-items:center;gap:8px;margin-bottom:7px;}
  .doms-lbl{font-size:12px;font-weight:500;color:var(--tx);flex:1;}
  .lnk{background:none;border:none;cursor:pointer;color:var(--T);
    font-size:11px;font-weight:600;padding:0;letter-spacing:.3px;}
  .lnk:hover{opacity:.8;}
  ...
  .ddi{padding:8px 12px;font-size:12px;color:var(--tx);cursor:pointer;
    display:flex;justify-content:space-between;align-items:center;}
  .ddi:hover{background:rgba(255,132,0,.1);color:var(--T);}
  .ddi-cnt{font-size:10px;color:var(--sub);}
  ...
  .dtag{display:flex;align-items:center;gap:4px;padding:3px 8px 3px 10px;
    ...
    border-radius:14px;font-size:11px;color:var(--T);font-weight:500;}
  .dtag-rm{cursor:pointer;font-size:14px;line-height:1;opacity:.7;margin-left:2px;}
  ...
  .chip{padding:3px 9px;border-radius:12px;font-size:11px;cursor:pointer;
  ...
  .chip-c{opacity:.65;font-size:10px;}
  ...
  .btn{display:inline-flex;align-items:center;gap:4px;padding:6px 12px;
    border-radius:6px;border:none;cursor:pointer;font-size:11px;font-weight:600;
  ...
  /* Select all row */
  .sa{display:flex;align-items:center;gap:8px;padding:6px 10px;font-size:11px;
  ...
  .badge{flex-shrink:0;font-size:10px;font-weight:600;padding:2px 7px;
  ...
  .loading{display:flex;align-items:center;justify-content:center;height:160px;
    flex-direction:column;gap:12px;color:var(--sub);font-size:12px;}
  ...
  .empty{text-align:center;padding:36px 16px;color:var(--sub);font-size:12px;}
  ...
  .stxt{font-size:15px;font-weight:600;color:var(--tx);text-transform:capitalize;}
  .smeta{display:grid;grid-template-columns:auto 1fr;gap:4px 10px;font-size:12px;}
  ...
  .log-wrap h3{margin:0 0 8px;font-size:13px;font-weight:600;color:var(--tx);}
  .llist{display:flex;flex-direction:column;gap:1px;max-height:300px;overflow-y:auto;}
  .le{display:flex;gap:8px;padding:4px 6px;border-radius:4px;font-size:11px;}
  ...
  .lm{color:var(--sub);}
  .no-log{color:var(--sub);font-size:12px;text-align:center;padding:16px 0;}
`;
